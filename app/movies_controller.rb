...
def can_be_found_updated_and_saved
  ...
  mov_update = Movie.where(title: "Awesome Flick").update_all(title: "Even Awesomer Flick")

end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  mov = Movie.create(title: "Wat?").id
  Movie.update(mov, title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  mov = Movie.create(title: "That One Where the Guy Kicks Another Guy Once").id
